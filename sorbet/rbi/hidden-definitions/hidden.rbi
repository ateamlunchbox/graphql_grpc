...
class Google::Protobuf::Descriptor
  include ::Enumerable
  include ::GraphqlGrpc::DescriptorExt
end
...
class Google::Protobuf::EnumDescriptor
  include ::Enumerable
  include ::GraphqlGrpc::EnumDescriptorExt
end

class Google::Protobuf::FieldDescriptor
  include ::GraphqlGrpc::FieldDescriptorExt
end
...
module RubyRobot
  USE_SWAGGER_EXPOSER = ::T.let(nil, ::T.untyped)
  VERSION = ::T.let(nil, ::T.untyped)
end
...
class RubyRobot::Webapp
  ERR_PLACEMENT_MSG = ::T.let(nil, ::T.untyped)
  REPORT_EXAMPLE = ::T.let(nil, ::T.untyped)
  REPORT_EXAMPLE_OBJ = ::T.let(nil, ::T.untyped)
end
...
module Wirble::Colorize
  DEFAULT_COLORS = ::T.let(nil, ::T.untyped)
  TESTING_COLORS = ::T.let(nil, ::T.untyped)
end
